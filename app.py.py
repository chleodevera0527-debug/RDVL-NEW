...
/* Compatibility styling for existing application components — CSS only. */
.page{min-height:100vh}
.notice,.ok,.error,.issue{padding:12px 14px;border-radius:var(--radius);margin-bottom:14px;border:1px solid var(--border)}
.notice,.ok{background:var(--success-light);color:#166534;border-color:#a7f3d0}
.error,.issue{background:var(--danger-light);color:#991b1b;border-color:#fecaca}
.live{display:inline-flex;align-items:center;gap:8px;background:var(--success-light);color:#047857;border:1px solid #a7f3d0;border-radius:999px;padding:6px 10px;font-size:11px;font-weight:700;margin-bottom:12px}
...
input,select,textarea{width:100%;margin-top:6px;border:1px solid var(--border);border-radius:var(--radius-sm);padding:10px 12px;background:var(--surface);color:var(--text);outline:none}
input:focus,select:focus,textarea:focus{border-color:var(--primary);box-shadow:0 0 0 3px var(--primary-light)}
textarea{min-height:90px;resize:vertical}
button,.button{display:inline-flex;align-items:center;justify-content:center;gap:6px;min-height:40px;padding:9px 15px;border:0;border-radius:var(--radius-sm);background:var(--primary);color:#fff;font-weight:600;cursor:pointer;text-decoration:none}
button:hover,.button:hover{background:var(--primary-dark)}
.button.secondary{background:var(--surface-2);color:var(--text);border:1px solid var(--border)}
.button.secondary:hover{background:var(--primary-light);color:var(--primary-dark)}
...
.card th{background:var(--surface-2);color:var(--muted);font-size:12px;font-weight:700;text-align:left;padding:11px 12px;border-bottom:1px solid var(--border)}
.card td{padding:11px 12px;border-bottom:1px solid var(--border);font-size:13px}
.card tr:last-child td{border-bottom:0}
.table-wrap{overflow-x:auto}
.tag{display:inline-flex;align-items:center;padding:4px 8px;border-radius:999px;background:var(--primary-light);color:var(--primary-dark);font-size:11px;font-weight:700}
.tag.status{background:var(--success-light);color:#047857}
.admin-actions,.master-data-actions{display:flex;gap:8px;align-items:center}
.account-page-grid{display:grid;grid-template-columns:minmax(280px,1fr) minmax(320px,1.4fr);gap:16px}
.profile-hero{display:flex;align-items:center;gap:14px;padding-bottom:18px;border-bottom:1px solid var(--border)}
.profile-avatar{width:64px;height:64px;font-size:18px}
.profile-info{display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-top:18px}
.profile-info div{padding:12px;border:1px solid var(--border);border-radius:var(--radius-sm);background:var(--surface-2)}
.profile-info span{display:block;color:var(--muted);font-size:10px;font-weight:700;margin-bottom:4px}
