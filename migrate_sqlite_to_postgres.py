"""One-time migration helper for R.DEVERA Truck Monitor.

Usage:
  DATABASE_URL='postgresql://...' python migrate_sqlite_to_postgres.py truck_monitor.db

The script initializes the PostgreSQL schema using app.py, copies all business
rows, preserves primary keys, and resets PostgreSQL sequences afterward.
"""
import os
import sqlite3
import sys
...
with app.db() as dst:
    ...
    # Preserve integer IDs for future inserts.
